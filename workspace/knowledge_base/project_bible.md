...
|------|--------------------|------------------------|----------------------------------|
| 8000 | Frontend (Vite)    | AgentLee-Frontend      | node_modules/vite/bin/vite.js    |
| 8001 | Backend (Express)  | AgentLee-Backend       | backend/dist/index.js            |
| 8002 | MCP Bridge         | AgentLee-Bridge        | vscode-mcp-tooling/src/bridge.js |
| 8003 | WebSocket          | (part of Backend)      | backend/src/ws.ts                |
| 8004 | Brain (FastAPI)    | AgentLee-Brain         | server.py                        |
| 8005 | Vision Agent       | AgentLee-Hands         | scripts/vision_agent.py          |
...
```
AgentLee-Brain          online  port 8004   server.py (FastAPI + Qwen)
AgentLee-Backend        online  port 8001   backend/dist/index.js (Express)
AgentLee-Frontend       stopped port 8000   Vite build (one-shot, autorestart:false)
AgentLee-Bridge         online  port 8002   vscode-mcp-tooling/src/bridge.js
AgentLee-Hands          online  port 8005   scripts/vision_agent.py  <- NEW
...
Invoke-RestMethod -Method POST http://127.0.0.1:8005/stream/start

# Test chat
Invoke-RestMethod -Method POST http://127.0.0.1:8004/chat `
...
*Last updated by GitHub Copilot — 2026-02-20 — perception layer v1 shipped*
